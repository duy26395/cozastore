...
<body class="animsition">
                ...
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
                            ...
                            <a href="login.php"><i class="zmdi zmdi-accounts"></i></a><?php
}?>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-7 p-b-30">
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w wrap-slick3-ProductDetail">
                            <div class="wrap-slick3-dots wrap-slick3-dots-ProductDetail"></div>
                            <div class="wrap-slick3-arrows flex-sb-m flex-w wrap-slick3-arrows-ProductDetail"></div>
                    ...
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <input class="stext-104 cl2 plh4 size-111 bor8 p-lr-20 m-r-10 m-tb-5" type="text"
                                        name="noteitem" placeholder="Note">
                                </div>
                            </div>
                            <div class="flex-w flex-r-m p-b-10">
    ...
    urlParams = parseURLParams(window.location.search);
    var key;
    if (typeof urlParams == 'undefined') {
        urlParams = null;
        $(document).die();
    } else {
        key = urlParams['search'][0];
    }
    $.ajax({
        ...
        success: function(data) {
            if (data.IsView) {
                ...
                swal(data.IsView, "Error", "warning");
            }
        }
    })
    /*-----------------------------------------------------*/
    $.ajax({
        ...
        data: {
            iditem: key,
            method: "get-Productdetail-Related"
        },
        cache: false,
        success: function(data) {
            $('.slick2').html(data);
